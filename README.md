...
- **View objective:** 
    ...
    **1.** Created a _[Home Page](https://github.com/RaihanFAU/Atliq-Hardware-Business-Insights/blob/main/Home-Page.pdf)_ fro the user to navigate to different Views in the Dashboard.
